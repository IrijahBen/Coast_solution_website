# Contributing to CoastApp

Thank you for helping improve CoastApp. This guide is for everyone contributing through normal open-source channels and for contributors working via **[Drips Wave — Stellar](https://www.drips.network/wave/stellar)**.

---

## Contributing through Drips Wave

CoastApp may list work on the Stellar Wave program on Drips. If you are picking up an issue from there:
